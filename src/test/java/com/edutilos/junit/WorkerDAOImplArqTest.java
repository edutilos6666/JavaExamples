 ...
 */
/**
 * we have currently 2 TestRunners : Arquillian Testng and Aqruillian JUnit
 * So Arquillian JUnit throws Exception because of multiple TestRunners ->
 * We have to remove Arquillian Testng from our cp first!
*/
@RunWith(Arquillian.class)
public class WorkerDAOImplArqTest {
    @Inject
